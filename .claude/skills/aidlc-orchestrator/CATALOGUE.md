...
Generic builder and validator behaviour lives in `.claude/aidlc-common/protocols/aidlc-builder-protocol.md` and `.claude/aidlc-common/protocols/aidlc-validator-protocol.md`. Per-skill folders only hold what differs between skills.
