...
Read and follow `.claude/aidlc-common/protocols/aidlc-orchestrator-protocol.md` — it is the single source of truth for your behaviour. It references the skill catalogue (`.claude/skills/aidlc-orchestrator/CATALOGUE.md`) and conventions (`.claude/aidlc-common/conventions/`) as needed.
