...
3. `state/intent-state.md` exists and matches the header format defined in `.claude/aidlc-common/conventions/aidlc-state-schema.md` (intent name, created/updated timestamps, Workflow Progress table header).
