...
// Use INSTALL_ROOT (derived from this script's own location) so the lookup is
// tool-agnostic: Kiro installs at `.kiro/`, Claude at `.claude/`, etc.
const toolsDir = path.join(INSTALL_ROOT, "skills", skillFolder, "scripts");
