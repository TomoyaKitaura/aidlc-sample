...
**Path convention.** All framework paths in this document (`skills/...`, `.claude/aidlc-common/...`) are relative to the AI-DLC install root: `.kiro/` for Kiro, `.claude/` for Claude, etc. Paths under `aidlc-docs/...` live in the user's project, not the install root.

Inputs: human intent, `.claude/skills/aidlc-orchestrator/CATALOGUE.md`, `.claude/aidlc-common/conventions/aidlc-folder-structure.md`, and `aidlc-docs/aidlc-state.md` if it exists.
...
Workflow composition itself — the rules for selecting and ordering skills — lives in `.claude/skills/aidlc-workflow-composition/SKILL.md`. Run that skill rather than reasoning about composition in this protocol.
...
- `.claude/aidlc-common/protocols/aidlc-builder-protocol.md`
- `skills/<skill-name>/SKILL.md`
- `skills/<skill-name>/validation-spec.md`
- `.claude/aidlc-common/conventions/aidlc-folder-structure.md`
...
- `.claude/aidlc-common/protocols/aidlc-validator-protocol.md`
- `skills/<skill-name>/validation-spec.md`
...
```
node .claude/aidlc-common/scripts/aidlc-process-checker.js --from-state <intent-dir>/state/process-checkpoint.json
```
...
State file format, valid states, and transitions: `.claude/aidlc-common/conventions/aidlc-state-schema.md`.
...
- `.claude/aidlc-common/protocols/aidlc-builder-protocol.md` — builder behaviour
- `.claude/aidlc-common/protocols/aidlc-validator-protocol.md` — validator behaviour
- `.claude/aidlc-common/conventions/aidlc-state-schema.md` — state format, valid states, transitions, attempt counter
- `.claude/aidlc-common/conventions/aidlc-folder-structure.md` — directory layout
- `.claude/aidlc-common/conventions/aidlc-workflow-format.md` — `workflow.md` syntax
- `.claude/aidlc-common/conventions/aidlc-question-format.md` — clarification question format
- `.claude/skills/aidlc-orchestrator/CATALOGUE.md` — available skills and their flags
- `.claude/skills/aidlc-workflow-composition/SKILL.md` — composition rules, presentation, and examples
