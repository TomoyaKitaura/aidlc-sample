...
- Path to `.claude/aidlc-common/conventions/aidlc-folder-structure.md`
...
3. Determine output paths from `.claude/aidlc-common/conventions/aidlc-folder-structure.md`.
...
- Generate clarifying questions using `.claude/aidlc-common/conventions/aidlc-question-format.md`.
...
See `.claude/aidlc-common/conventions/aidlc-state-schema.md` for the state file format, valid states, and transitions.
